...
<xsl:stylesheet xmlns:dc="http://purl.org/dc/terms/"
    ...
    <xsl:template name="deliverable-unit-scope-content">
        <xsl:if test="exists(Metadata/tna:metadata/rdf:RDF/tna:BornDigitalRecord/tna:cataloguing/tna:Cataloguing/tna:curatedTitle)">
        ...
        <ScopeContent>
            <Description>
                <xsl:text>&lt;scopecontent&gt;</xsl:text>
                 <xsl:text>&lt;p&gt;Curated title: </xsl:text>
